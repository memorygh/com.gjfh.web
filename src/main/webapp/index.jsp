                ...
                <div class="col-sm-6">
                    <div class="footer-content">
                        ...
                        <ul class="social-links">
                            ...
                            <li class="paw"><a target="_blank" href="http://www.baidu.com"><i class="fa fa-paw"></i></a></li>
                            <li class="weixin"><a target="_blank" href="http://wx.qq.com"><i class="fa fa-weixin"></i></a></li>
                            <li class="renren"><a target="_blank" href="http://www.renren.com"><i class="fa fa-renren"></i></a></li>
                            <li class="weibo"><a target="_blank" href="http://www.weibo.com"><i class="fa fa-weibo"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
